...
class CreateEmployeeUseCaseTest {
    ...
    void setUp() {
        ...
        createEmployeeUseCase = new CreateEmployeeUseCase(userPersistencePort, passwordEncoderPort);
    }
    ...
    void When_EmployeeInformationIsCorrect_Expect_EmployeeToBeSavedSuccessfully() {
        UserModel savedEmployee = UserModelFactory.createSavedUser(UserModelFactory.createEmployeeRole());
    ...
    void When_EmployeeInformationIsCorrect_Expect_PasswordToBeEncoded() {
        ...
        UserModel savedEmployee = UserModelFactory.createSavedUserWithPassword(
                UserModelFactory.createEmployeeRole(), ENCODED_PASSWORD);
